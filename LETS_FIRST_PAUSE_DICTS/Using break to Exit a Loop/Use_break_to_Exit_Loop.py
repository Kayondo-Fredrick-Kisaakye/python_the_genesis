...
# We can stop the while loop in this program by calling break as soon 
...
# A loop that starts with while True 14 will run forever unless it reaches a 
# break statement. The loop in this program continues asking the user to enter 
# the names of cities they’ve been to until they enter 'quit'. When they enter 'quit',
# the break statement runs, causing Python to exit the loop:
